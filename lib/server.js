...
app.use(bodyParser.json({
  ...
  //     return value
  //   }
  //   // Escape all strings to prevent xss attacks
  //   return xss(value, {
  //     whitelist: [], // Filter ALL tags!
  //     stripIgnoreTag: true,
  //     onTag: function (tag, value) {
  //       if (tag === 'img') {
...
fs.readdirSync('/routes/').forEach((route) => require('../api/routes/' + route)(app))
